# Determine birth path number inside a method.
...
# Display number to user in a method
def get_message(birth_path_num)
    case birth_path_num 
        when 1
            message = "You're numerology number is #{birth_path_num}.\nOne is the leader. The number one indicates the ability to stand alone and is a strong vibration. Ruled by the Sun"
        when 2
        ...
        when 9
            ...
            message "Oops that not a number between 1-9. Try again!"
    end
end
